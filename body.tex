...
has a higher sense of obligation to do something about the nuclear waste problem.
% an elegant way to expresss this? 
...
\begin{figure}[!h] 
  \centering
  \includegraphics[width=0.8\columnwidth]{CN-stations.png}	
        \caption{From \cite{CN_network}, a map of Clinton Power Station in Clinton,IL
        with the Canadian National rail passing through.}
  \label{fig:CN-stations}
\end{figure}
