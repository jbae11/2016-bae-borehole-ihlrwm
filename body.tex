...
\begin{table}[h]
	...
	%\scalebox{0.60}{
		\begin{tabular}{|c|c|c|c|c|}
			\hline
			Case & Net Nuclear Capacity (MW) & Census Population & \gls{NMWPC} ($10^{-3}$) \\ \hline
			Case I & 0 & 2,705,000 & 0 \\ \hline
			Case II & 11,441 & 12,831,549 & .89 \\ \hline
                \end{tabular}
                %}
\end{table}
