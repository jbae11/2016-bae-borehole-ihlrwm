...
\subsection{Reference Case Definition}

The reference case  

\subsection{Proposed Case Definition}


\subsection{Two Repository Case Definition}

\section{Proposed Metrics}

To quantify the benefits of this repository design, a set of metrics are 
proposed. In the following sections, the proposed metrics are defined and 
...
based approach to siting a repository is crucial. For such a development to happen,
